...
そこで、本研究では、複数のスタイル画像を用いたニューラルスタイル転送におけるスタイル画像の与え方の違い、勾配計算のための損失関数の切り替え、また、ニューラルスタイル転送における初期画像の違いが分類精度に与える影響を調べることを目的とする。
さらに、データ拡張手法を組み合わせることによる影響も明らかにする。
