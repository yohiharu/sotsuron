...
### VGGNet
VGGNetは、代表的な畳み込みニューラルネットワークの1つである。オックスフォード大学のVisual Geometry Groupによって、2014年に提案された。VGGNetは、16層であるVGG16と、19層であるVGG19がある。

まず、VGG16について説明する。以下の図が、VGG16のアーキテクチャである。VGG19の特徴として、
