...
トレーニングセットの画像を、テストセットの画像を用いてスタイル転送することで、テストデータのドメインを反映した新たな学習用画像を生成する。生成された画像は、元のトレーニングセットのコンテンツの情報を保持したまま、テストデータのドメインに近いスタイルであるため、ソースドメインとターゲットドメイン間の分布の差を緩和する効果が期待できる。
