...
第2章では、関連研究として、畳み込みニューラルネットワークの特徴と、本研究で用いるVGGNetの構造と特徴について説明する。また、ドメイン適応およびデータ拡張に関する既存研究を整理し、ニューラルスタイル転送をデータ拡張に応用した研究事例について述べる。
...
## 関連研究
本章では、本研究で利用する畳み込みニューラルネットワークの概要とその特徴を示し、本研究で実際に用いるVGGNetの構造と特徴について、説明する。また、ドメイン適応とデータ拡張について、問題設定と既存の研究を説明する。さらに、スタイル転送をデータ拡張に用いた事例を紹介する。そして、本研究の目的について述べる
