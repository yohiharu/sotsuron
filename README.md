...
また、統計量を調整することによって、ソースドメインとターゲットドメインにおける特徴量の平均や分散などの統計的性質を揃えることで、分布のずれを直接的に低減し、ドメインの違いに依存しない安定した推論性能を実現することが可能となる。
生成モデルを使ったアプローチでは、ターゲットドメインに似たデータを生成することで、ソースドメインのラベル付きデータをターゲットドメイン向けに変換したり、データの表現を補強したりすることができる。
