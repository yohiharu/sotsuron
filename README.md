...
まず、VGG16について説明する。VGG16は、畳み込み層13層と全結合層3層で構成されている。パラメータ数は、約1億3800万である。図は、VGG16のアーキテクチャを示している。層が比較的浅いため、学習速度は速いが、精度が若干低くなる。

まず、VGG19について説明する。VGG19は、畳み込み層16層と全結合層3層で構成されている。パラメータ数は、約1億4400万である。図は、VGG19のアーキテクチャを示している。層が比較的深いため、学習速度は遅いが、精度が若干高くなる。
