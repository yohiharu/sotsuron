...
一般に、ニューラルスタイル転送では、スタイル画像は1枚のみ用いる。しかし、本研究で行う問題では、スタイル画像を複数用いることができる状況を考える。このような問題設定において、

また、Leon A. Gatysらによるニューラルスタイル転送では、初期画像を

## 提案手法
本章では、本研究で提案する、ニューラルスタイル転送を用いたデータ生成によるドメイン適応の手法について、説明する。また、提案する手法によって期待する効果についても説明する。

### 基本方針
。その問題に対応しモデルの精度を向上するために、そして、新たなデータセットを生成することによって、これにより、ターゲットドメインの特徴を間接的に学習可能な新たなデータセットを構築し、半教師ありドメイン適応における分類精度の向上を目指す。
