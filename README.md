...
題3章では、本研究で提案するニューラルスタイル転送を活用するデータ拡張の手法について述べる。また、提案する手法によって期待する成果について、どのように測定するかも含めて述べる。
題4章では、本研究で行う実験の具体的な環境と、実験の結果について述べる。
...
以下の図は、Justin Johnsonらによって提案されたニューラル転送のアーキテクチャを示している。
