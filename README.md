...
ニューラルスタイル転送におけるコンテンツ特徴およびスタイル特徴の抽出を行う畳み込みニューラルネットワークは、VGG19を用いる。コンテンツ特徴の抽出には、block5_conv2を、一方、スタイル特徴の抽出には、block1_conv1、block2_conv1、block3_conv1、block4_conv1、block5_conv1の5つの畳み込み層を用いる。
