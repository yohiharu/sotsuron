...
ここで、本研究で扱う問題設定では、スタイル画像が1枚に限定されるとは限らず、複数枚存在する状況が想定される。また、ニューラルスタイル転送では、生成過程や初期条件の違いによって得られる画像の特徴が変化することが知られている。そこで、スタイル画像の数や扱い方、生成過程における条件設定の違い、ならびにデータ拡張手法の組み合わせが、半教師ありドメイン適応における分類性能にどのような影響を与えるのかを明らかにし、分類性能を向上させるための知見を得ることを目指す。
<!--
