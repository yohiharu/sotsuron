...
また、画像の更新において、勾配計算をする際に用いる損失関数を毎回同じにする方法が、一般的に用いられている。しかし、損失関数を適切に切り替えながら勾配計算を行い画像の更新を行うことができると、考える。そして、勾配計算において、局所最小値にとどまることを、防ぐことができる可能性があると、考える。

さらに、古典的なデータ拡張手法であるFlippingとRotationも組み合わせることによって、
