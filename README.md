...
次に、VGG19について説明する。VGG19は、畳み込み層16層と全結合層3層で構成されている。パラメータ数は約1億4400万である。図は、VGG19のアーキテクチャを示している。層が比較的深いため、学習速度は遅いが、精度が若干高くなる。比較的多くの処理能力が必要になるので、十分な計算リソースがある場合は、VGG19を選択するべきであると、考えられる。
